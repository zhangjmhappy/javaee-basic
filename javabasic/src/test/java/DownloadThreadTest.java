...
//			.getLogger(DownloadThreadTest.class);
	...
	public void run() {
		System.setProperty("javax.net.ssl.trustStore", "D:\\devTool\\Java\\jre1.8.0_77\\lib\\security\\jssecacerts");
		try {
			...
			System.out.println("DownloadThread exception msg:"+ ExceptionUtils.getStackTrace(e));
		} catch (IOException e) {
//			LOGGER.error("DownloadThread exception msg:{}",ExceptionUtils.getStackTrace(e));
			System.out.println("DownloadThread exception msg:{}"+ExceptionUtils.getStackTrace(e));
		} finally {
			end.countDown();
